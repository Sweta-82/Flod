...
// When that happens, translate no longer maps to viewport coordinates, so we compensate.
...
const TargetCursor = ({
  targetSelector = ".cursor-target, button, a, [role='button'], input, select, textarea",
  spinDuration = 2,
  ...
  return (
    ...
    >
      ...
      <div
        ref={dotRef}
        className="absolute top-1/2 left-1/2 w-1.5 h-1.5 rounded-full -translate-x-1/2 -translate-y-1/2 transition-colors"
